...
import {
    ...
    rotateX,
    rotateY,
    scalem, rotateZ, initFileShaders
...
let vTexCoord:GLint;
let vNormal:GLint;
let vShininess:GLint;
let vTangent:GLint;

/* Uniform Locations */
let umv:WebGLUniformLocation; //index of my shader uniform
let uproj:WebGLUniformLocation; //index of projection shader uniform
let uTextureSampler:WebGLUniformLocation; //Textrue Sampler in fShader
let uNormalSampler:WebGLUniformLocation; //Textrue Sampler in fShader
let uSpecSampler:WebGLUniformLocation; //Textrue Sampler in fShader
let uCloudSampler:WebGLUniformLocation; //Textrue Sampler in fShader
let uNightSampler:WebGLUniformLocation; //Textrue Sampler in fShader
let MODE:WebGLUniformLocation; //Lighting Mode

/* Lighting Uniforms */
let ambLight:WebGLUniformLocation;
let highlightColor:WebGLUniformLocation;
//Sun Light Uniforms
let sunPos:WebGLUniformLocation;
let sunColor:WebGLUniformLocation;

/* Texture Vars */
let earthtex:WebGLTexture;
let earthimg:HTMLImageElement;
let earthnormaltex:WebGLTexture;
let earthnormalimg:HTMLImageElement;
let earthspectex:WebGLTexture;
let earthspecimg:HTMLImageElement;
let earthnighttex:WebGLTexture;
let earthnightimg:HTMLImageElement;
let cloudtex:WebGLTexture;
let cloudimg:HTMLImageElement;

/* Matricies */
let MV:mat4; //Model View Matrix
let P:mat4;  //Projection Matrix
...
/* zoom into the scene */
function zoom(){
    var slider = document.getElementById("zoom") as HTMLInputElement;
...
function generateSphere(subdiv:number,radius:number){
